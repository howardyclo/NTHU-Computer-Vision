...
if QUICK_DEMO == 1
    ...
    save('part_2c_result', 'similarity2x2');
    save('part_2c_result', 'similarity3x3', '-append');
    save('part_2c_result', 'similarity4x4', '-append');
    save('part_2c_result', 'similarity9x9', '-append');
    save('part_2c_result', 'similarity20x20', '-append');
end
